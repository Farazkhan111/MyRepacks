...
exports.AddGame= async (req,res)=>{
    // console.log(req.body)
    try{
        const newgame= await games({ name:req.body.gname,image:req.body.gimage,othername:req.body.othername,description:req.body.gdes,category:req.body.gcat, trending:req.body.gtrend,link:req.body.glink,fimage:req.body.gfimage})
        newgame.save();
        res.send(newgame);
    }
    catch(err){
...
exports.Gupdate=async(req,res)=>{
    try{
        await games.updateOne({_id:req.body.id},{$set:{name:req.body.gname,image:req.body.gimage,othername:req.body.othername,description:req.body.gdes,category:req.body.gcat, trending:req.body.gtrend,link:req.body.glink,fimage:req.body.gfimage,video:req.body.gvideo}})
        res.send("Update");
...
exports.Newcomments = async (req, res) => {
    try {
        const comment = new comments({
            ...
            // or better yet, just use Date.now() if it's a new comment
            postdate: new Date() 
        });
        await comment.save();
        res.send("done");
