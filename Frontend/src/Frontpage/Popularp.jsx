...
import url from './url'
import { Reveal, useTilt } from './ScrollFx'

function TrendingCard({ game, index, onClick }) {
    ...
    >
      ...
      <div className="game-card-info">
        ...
        <div className="game-card-meta">
          {game.category && <span className="game-card-cat">{game.category}</span>}
    ...
    <section className="trending-section">
      ...
      <div className="trending-grid">
        {trending.map((game, index) => (
          <Reveal key={game._id || index} delay={(index % 6) * 60}>
            <TrendingCard
              game={game}
              index={index}
